...
const pesos: Weight = new Weight([2, 2, 2, 2, 2]);
const gabarito: Answer = new Answer("Gabarito", ["a", "b", "a", "d", "c"]);
const prova: Exam = new Exam(gabarito, pesos);

// Cadastro das provas dos alunos

const provaCaio: Answer = new Answer("Caio", ["a", "b", "c", "a", "b"]);
const provaSerafim: Answer = new Answer("Serafim", ["c", "a", "d", "a", "c"]);
const provaDouglas: Answer = new Answer("Douglas", ["a", "b", "a", "d", "c"]);
